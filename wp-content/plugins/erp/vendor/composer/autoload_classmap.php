...
return array(
    ...
    'WeDevs\\ERP\\API\\API_Registrar' => $baseDir . '/includes/api/class-api-registrar.php',
    'WeDevs\\ERP\\API\\Accounting_Reports_Controller' => $baseDir . '/includes/api/class-accounting-reports-controller.php',
    'WeDevs\\ERP\\API\\Activities_Controller' => $baseDir . '/includes/api/class-activities-controller.php',
    'WeDevs\\ERP\\API\\Announcements_Controller' => $baseDir . '/includes/api/class-announcements-controller.php',
    'WeDevs\\ERP\\API\\Bank_Accounts_Controller' => $baseDir . '/includes/api/class-bank-accounts-controller.php',
    'WeDevs\\ERP\\API\\Chart_Of_Accounts_Controller' => $baseDir . '/includes/api/class-chart-of-accounts-controller.php',
    'WeDevs\\ERP\\API\\Contacts_Controller' => $baseDir . '/includes/api/class-contacts-controller.php',
    'WeDevs\\ERP\\API\\Contacts_Groups_Controller' => $baseDir . '/includes/api/class-contacts-groups-controller.php',
    'WeDevs\\ERP\\API\\Customers_Controller' => $baseDir . '/includes/api/class-customers-controller.php',
    'WeDevs\\ERP\\API\\Departments_Controller' => $baseDir . '/includes/api/class-departments-controller.php',
    'WeDevs\\ERP\\API\\Designations_Controller' => $baseDir . '/includes/api/class-designations-controller.php',
    'WeDevs\\ERP\\API\\Employees_Controller' => $baseDir . '/includes/api/class-employees-controller.php',
    'WeDevs\\ERP\\API\\Expenses_Controller' => $baseDir . '/includes/api/class-expenses-controller.php',
    'WeDevs\\ERP\\API\\HRM_Reports_Controller' => $baseDir . '/includes/api/class-hrm-reports-controller.php',
    'WeDevs\\ERP\\API\\Journals_Controller' => $baseDir . '/includes/api/class-journals-controller.php',
    'WeDevs\\ERP\\API\\Leave_Entitlements_Controller' => $baseDir . '/includes/api/class-leave-entitlements-controller.php',
    'WeDevs\\ERP\\API\\Leave_Holidays_Controller' => $baseDir . '/includes/api/class-leave-holidays-controller.php',
    'WeDevs\\ERP\\API\\Leave_Policies_Controller' => $baseDir . '/includes/api/class-leave-policies-controller.php',
    'WeDevs\\ERP\\API\\Leave_Requests_Controller' => $baseDir . '/includes/api/class-leave-requests-controller.php',
    'WeDevs\\ERP\\API\\REST_Controller' => $baseDir . '/includes/api/class-rest-controller.php',
    'WeDevs\\ERP\\API\\Sales_Controller' => $baseDir . '/includes/api/class-sales-controller.php',
    'WeDevs\\ERP\\API\\Schedules_Controller' => $baseDir . '/includes/api/class-schedules-controller.php',
    'WeDevs\\ERP\\API\\Vendors_Controller' => $baseDir . '/includes/api/class-vendors-controller.php',
    'WeDevs\\ERP\\Accounting\\Accounting' => $baseDir . '/modules/accounting/accounting.php',
    'WeDevs\\ERP\\Accounting\\Admin_Menu' => $baseDir . '/modules/accounting/includes/class-admin-menu.php',
    'WeDevs\\ERP\\Accounting\\Ajax_Handler' => $baseDir . '/modules/accounting/includes/class-ajax.php',
    'WeDevs\\ERP\\Accounting\\CLI\\Commands' => $baseDir . '/modules/accounting/includes/cli/commands.php',
    'WeDevs\\ERP\\Accounting\\Customer_List_Table' => $baseDir . '/modules/accounting/includes/class-customer-list-table.php',
    'WeDevs\\ERP\\Accounting\\Customer_Transaction_List_Table' => $baseDir . '/modules/accounting/includes/class-customer-transaction-list-table.php',
    'WeDevs\\ERP\\Accounting\\Emails\\Accounting_Invoice_Email' => $baseDir . '/modules/accounting/includes/class-email-send-invoice.php',
    'WeDevs\\ERP\\Accounting\\Expense_Transaction_List_Table' => $baseDir . '/modules/accounting/includes/class-expense-transaction-list-table.php',
    'WeDevs\\ERP\\Accounting\\Form_Handler' => $baseDir . '/modules/accounting/includes/class-form-handler.php',
    'WeDevs\\ERP\\Accounting\\Install' => $baseDir . '/modules/accounting/includes/class-install.php',
    'WeDevs\\ERP\\Accounting\\Journal_Transactions_List_Table' => $baseDir . '/modules/accounting/includes/class-journal-transactions-list-table.php',
    'WeDevs\\ERP\\Accounting\\Logger' => $baseDir . '/modules/accounting/includes/class-log.php',
    'WeDevs\\ERP\\Accounting\\Model\\Bank' => $baseDir . '/modules/accounting/includes/models/bank.php',
    'WeDevs\\ERP\\Accounting\\Model\\Chart_Classes' => $baseDir . '/modules/accounting/includes/models/chart-classes.php',
    'WeDevs\\ERP\\Accounting\\Model\\Chart_Of_Accounts' => $baseDir . '/modules/accounting/includes/models/chart-of-accounts.php',
    'WeDevs\\ERP\\Accounting\\Model\\Chart_Type' => $baseDir . '/modules/accounting/includes/models/chart-type.php',
    'WeDevs\\ERP\\Accounting\\Model\\Journal' => $baseDir . '/modules/accounting/includes/models/journal.php',
    'WeDevs\\ERP\\Accounting\\Model\\Ledger' => $baseDir . '/modules/accounting/includes/models/ledger.php',
    'WeDevs\\ERP\\Accounting\\Model\\Payment' => $baseDir . '/modules/accounting/includes/models/payment.php',
    'WeDevs\\ERP\\Accounting\\Model\\Tax' => $baseDir . '/modules/accounting/includes/models/tax.php',
    'WeDevs\\ERP\\Accounting\\Model\\Tax_Items' => $baseDir . '/modules/accounting/includes/models/tax-items.php',
    'WeDevs\\ERP\\Accounting\\Model\\Transaction' => $baseDir . '/modules/accounting/includes/models/transaction.php',
    'WeDevs\\ERP\\Accounting\\Model\\Transaction_Items' => $baseDir . '/modules/accounting/includes/models/transaction-items.php',
    'WeDevs\\ERP\\Accounting\\Model\\User' => $baseDir . '/modules/accounting/includes/models/user.php',
    'WeDevs\\ERP\\Accounting\\Sales_Transaction_List_Table' => $baseDir . '/modules/accounting/includes/class-sales-transaction-list-table.php',
    'WeDevs\\ERP\\Accounting\\Settings' => $baseDir . '/modules/accounting/includes/class-settings.php',
    'WeDevs\\ERP\\Accounting\\Transaction_List_Table' => $baseDir . '/modules/accounting/includes/class-transaction-list-table.php',
    'WeDevs\\ERP\\Accounting\\User_Profile' => $baseDir . '/modules/accounting/includes/class-user-profile.php',
    'WeDevs\\ERP\\Accounting\\Vendor_List_Table' => $baseDir . '/modules/accounting/includes/class-vendor-list-table.php',
    'WeDevs\\ERP\\Accounting\\Vendor_Transaction_List_Table' => $baseDir . '/modules/accounting/includes/class-vendor-transaction-list-table.php',
    'WeDevs\\ERP\\Accounting\\Walker_Charts' => $baseDir . '/modules/accounting/includes/class-walker-chart-of-accounts.php',
    'WeDevs\\ERP\\Admin\\Admin_Menu' => $baseDir . '/includes/admin/class-menu.php',
    'WeDevs\\ERP\\Admin\\Admin_Module' => $baseDir . '/includes/admin/class-module.php',
    'WeDevs\\ERP\\Admin\\Admin_Page' => $baseDir . '/includes/admin/class-admin.php',
    'WeDevs\\ERP\\Admin\\Ajax' => $baseDir . '/includes/admin/class-ajax.php',
    'WeDevs\\ERP\\Admin\\Auditlog_List_Table' => $baseDir . '/includes/admin/class-audit-list-table.php',
    'WeDevs\\ERP\\Admin\\Form_Handler' => $baseDir . '/includes/admin/class-form-handler.php',
    'WeDevs\\ERP\\Admin\\Models\\Audit_Log' => $baseDir . '/includes/admin/models/audit-log.php',
    'WeDevs\\ERP\\Admin\\Models\\Company_Locations' => $baseDir . '/includes/admin/models/company-locations.php',
    'WeDevs\\ERP\\Admin\\Setup_Wizard' => $baseDir . '/includes/admin/class-setup-wizard.php',
    'WeDevs\\ERP\\Admin\\User_Profile' => $baseDir . '/includes/admin/class-user-profile.php',
    'WeDevs\\ERP\\CRM\\Admin_Menu' => $baseDir . '/modules/crm/includes/admin/class-menu.php',
    'WeDevs\\ERP\\CRM\\Ajax_Handler' => $baseDir . '/modules/crm/includes/class-ajax.php',
    'WeDevs\\ERP\\CRM\\CLI\\Commands' => $baseDir . '/modules/crm/includes/cli/commands.php',
    'WeDevs\\ERP\\CRM\\CRM_Settings' => $baseDir . '/modules/crm/includes/admin/class-settings.php',
    'WeDevs\\ERP\\CRM\\Campaign_List_Table' => $baseDir . '/modules/crm/includes/class-campaigns-list-table.php',
    'WeDevs\\ERP\\CRM\\Contact' => $baseDir . '/modules/crm/includes/class-contact.php',
    'WeDevs\\ERP\\CRM\\ContactForms\\CF7' => $baseDir . '/modules/crm/includes/contact-forms/class-contact-forms-contact-form-7.php',
    'WeDevs\\ERP\\CRM\\ContactForms\\ContactForms' => $baseDir . '/modules/crm/includes/contact-forms/ContactForms.php',
    'WeDevs\\ERP\\CRM\\ContactForms\\Contact_Forms_Integration' => $baseDir . '/modules/crm/includes/contact-forms/class-contact-forms-integration.php',
    'WeDevs\\ERP\\CRM\\ContactForms\\ERP_Settings_Contact_Forms' => $baseDir . '/modules/crm/includes/contact-forms/class-erp-settings-contact-forms.php',
    'WeDevs\\ERP\\CRM\\ContactForms\\Ninja_Forms' => $baseDir . '/modules/crm/includes/contact-forms/class-contact-forms-ninja-forms.php',
    'WeDevs\\ERP\\CRM\\Contact_Group_List_Table' => $baseDir . '/modules/crm/includes/class-contact-group-list-table.php',
    'WeDevs\\ERP\\CRM\\Contact_List_Table' => $baseDir . '/modules/crm/includes/class-contact-list-table.php',
    'WeDevs\\ERP\\CRM\\Contact_Subscriber_List_Table' => $baseDir . '/modules/crm/includes/class-contact-subscriber-list-table.php',
    'WeDevs\\ERP\\CRM\\Customer_Relationship' => $baseDir . '/modules/crm/crm.php',
    'WeDevs\\ERP\\CRM\\Emailer' => $baseDir . '/modules/crm/includes/class-emails.php',
    'WeDevs\\ERP\\CRM\\Emails\\New_Task_Assigned' => $baseDir . '/modules/crm/includes/emails/class-email-new-task-assigned.php',
    'WeDevs\\ERP\\CRM\\Form_Handler' => $baseDir . '/modules/crm/includes/class-form-handler.php',
    'WeDevs\\ERP\\CRM\\Models\\Activity' => $baseDir . '/modules/crm/includes/models/activity.php',
    'WeDevs\\ERP\\CRM\\Models\\ActivityUser' => $baseDir . '/modules/crm/includes/models/activity-user.php',
    'WeDevs\\ERP\\CRM\\Models\\Campaign' => $baseDir . '/modules/crm/includes/models/campaign.php',
    'WeDevs\\ERP\\CRM\\Models\\ContactGroup' => $baseDir . '/modules/crm/includes/models/contact-group.php',
    'WeDevs\\ERP\\CRM\\Models\\ContactSubscriber' => $baseDir . '/modules/crm/includes/models/contact-subscriber.php',
    'WeDevs\\ERP\\CRM\\Models\\SaveSearch' => $baseDir . '/modules/crm/includes/models/save-search.php',
    'WeDevs\\ERP\\CRM\\Models\\Save_Replies' => $baseDir . '/modules/crm/includes/models/save-replies.php',
    'WeDevs\\ERP\\CRM\\Subscription' => $baseDir . '/modules/crm/includes/class-subscription.php',
    'WeDevs\\ERP\\CRM\\Subscription_Widget' => $baseDir . '/modules/crm/includes/class-subscription-widget.php',
    'WeDevs\\ERP\\CRM\\User_Profile' => $baseDir . '/modules/crm/includes/admin/class-user-profile.php',
    'WeDevs\\ERP\\Company' => $baseDir . '/includes/class-company.php',
    'WeDevs\\ERP\\Countries' => $baseDir . '/includes/class-countries.php',
    'WeDevs\\ERP\\Email' => $baseDir . '/includes/class-email.php',
    'WeDevs\\ERP\\Emailer' => $baseDir . '/includes/class-emailer.php',
    'WeDevs\\ERP\\Framework\\ERP_Admin_Settings' => $baseDir . '/includes/framework/class-settings.php',
    'WeDevs\\ERP\\Framework\\ERP_Settings_Page' => $baseDir . '/includes/framework/class-settings-page.php',
    'WeDevs\\ERP\\Framework\\Model' => $baseDir . '/includes/framework/Model.php',
    'WeDevs\\ERP\\Framework\\Models\\People' => $baseDir . '/includes/framework/models/peoples.php',
    'WeDevs\\ERP\\Framework\\Models\\PeopleTypes' => $baseDir . '/includes/framework/models/people_types.php',
    ...
    'WeDevs\\ERP\\HRM\\Admin\\Admin_Menu' => $baseDir . '/modules/hrm/includes/admin/class-menu.php',
    'WeDevs\\ERP\\HRM\\Admin\\User_Profile' => $baseDir . '/modules/hrm/includes/admin/class-user-profile.php',
    'WeDevs\\ERP\\HRM\\Ajax_Handler' => $baseDir . '/modules/hrm/includes/class-ajax.php',
    'WeDevs\\ERP\\HRM\\Announcement' => $baseDir . '/modules/hrm/includes/class-announcement.php',
    'WeDevs\\ERP\\HRM\\CLI\\Commands' => $baseDir . '/modules/hrm/includes/cli/commands.php',
    'WeDevs\\ERP\\HRM\\Department' => $baseDir . '/modules/hrm/includes/class-department.php',
    'WeDevs\\ERP\\HRM\\Department_List_Table' => $baseDir . '/modules/hrm/includes/class-department-list-table.php',
    'WeDevs\\ERP\\HRM\\Department_Walker' => $baseDir . '/modules/hrm/includes/class-walker-department.php',
    'WeDevs\\ERP\\HRM\\Designation' => $baseDir . '/modules/hrm/includes/class-designation.php',
    'WeDevs\\ERP\\HRM\\Designation_List_Table' => $baseDir . '/modules/hrm/includes/class-designation-list-table.php',
    'WeDevs\\ERP\\HRM\\Emailer' => $baseDir . '/modules/hrm/includes/class-emails.php',
    'WeDevs\\ERP\\HRM\\Emails\\Approved_Leave_Request' => $baseDir . '/modules/hrm/includes/emails/class-email-approved-leave-request.php',
    'WeDevs\\ERP\\HRM\\Emails\\HR_Announcement_Email' => $baseDir . '/modules/hrm/includes/emails/class-email-hr-announcement.php',
    'WeDevs\\ERP\\HRM\\Emails\\New_Employee_Welcome' => $baseDir . '/modules/hrm/includes/emails/class-email-new-employee-welcome.php',
    'WeDevs\\ERP\\HRM\\Emails\\New_Leave_Request' => $baseDir . '/modules/hrm/includes/emails/class-email-new-leave-request.php',
    ...
    'WeDevs\\ERP\\HRM\\Models\\Hr_User' => $baseDir . '/modules/hrm/includes/models/Hr_User.php',
    'WeDevs\\ERP\\HRM\\Models\\Leave' => $baseDir . '/modules/hrm/includes/models/leave.php',
    'WeDevs\\ERP\\HRM\\Models\\Leave_Entitlement' => $baseDir . '/modules/hrm/includes/models/leave-entitlement.php',
    'WeDevs\\ERP\\HRM\\Models\\Leave_Holiday' => $baseDir . '/modules/hrm/includes/models/leave-holiday.php',
    'WeDevs\\ERP\\HRM\\Models\\Leave_Policies' => $baseDir . '/modules/hrm/includes/models/leave-policies.php',
    'WeDevs\\ERP\\HRM\\Models\\Leave_request' => $baseDir . '/modules/hrm/includes/models/leave-request.php',
    'WeDevs\\ERP\\HRM\\Models\\Performance' => $baseDir . '/modules/hrm/includes/models/performance.php',
    'WeDevs\\ERP\\HRM\\Models\\Work_Experience' => $baseDir . '/modules/hrm/includes/models/work-experience.php',
    'WeDevs\\ERP\\HRM\\Settings' => $baseDir . '/modules/hrm/includes/class-settings.php',
    'WeDevs\\ERP\\Imap' => $baseDir . '/includes/class-imap.php',
    'WeDevs\\ERP\\Integration' => $baseDir . '/includes/class-integration.php',
    'WeDevs\\ERP\\Item' => $baseDir . '/includes/class-abstract-item.php',
    'WeDevs\\ERP\\Lib\\Emogrifier' => $baseDir . '/includes/lib/class-emogrifier.php',
    'WeDevs\\ERP\\License' => $baseDir . '/includes/class-license.php',
    'WeDevs\\ERP\\Log' => $baseDir . '/includes/class-log.php',
    'WeDevs\\ERP\\PDF_Invoicer' => $baseDir . '/includes/pdf/class-pdf-invoicer.php',
    'WeDevs\\ERP\\People' => $baseDir . '/includes/class-people.php',
    'WeDevs\\ERP\\Scripts' => $baseDir . '/includes/class-scripts.php',
    'WeDevs\\ERP\\Settings' => $baseDir . '/includes/class-settings.php',
    'WeDevs\\ERP\\Tracker' => $baseDir . '/includes/class-tracker.php',
    'WeDevs\\ERP\\Updates' => $baseDir . '/includes/class-updates.php',
    'WeDevs\\ERP\\Uploader' => $baseDir . '/includes/class-uploader.php',
    'WeDevs\\ERP\\tFPDF' => $baseDir . '/includes/pdf/tfpdf.php',
